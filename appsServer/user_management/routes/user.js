   ...
   router.delete("/user_delete/:id", tokenAuth, userAuth.isAdmin, userAuth.isAllowed, User_ctrl.delete);
   router.put("/user_update/:id", tokenAuth, userAuth.isAdmin, userAuth.isAllowed, User_ctrl.user_update);
