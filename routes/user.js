   ...
   router.delete("/user_delete/:id", sysAuth, userAuth.Admin, userAuth.Allowed, User_ctrl.delete);
   router.put("/user_update/:id", sysAuth, userAuth.Admin, userAuth.Allowed, User_ctrl.user_update);
