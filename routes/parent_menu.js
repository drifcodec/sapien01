...
//
 //router.get('/',checkAuth,RoleAuth.admin_role,(req,res)=>{
  ...
  router.post('/parent_menu_create', parent_menu_ctrl.parent_menu_create)
  router.put("/:id",parent_menu_ctrl.parent_menu_update);
  router.delete('/:id',parent_menu_ctrl.parent_menu_delete)
