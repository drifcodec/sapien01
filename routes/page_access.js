...
router.post('/page_access_create', userAuth.isAdmin, userAuth.isAllowed, page_access_ctrl.Page_access_create)
router.put("/:id", userAuth.isAdmin, userAuth.isAllowed, page_access_ctrl.Page_access_update);
router.delete('/:id', tokenAuth, userAuth.isAdmin, userAuth.isAllowed, page_access_ctrl.Page_access_delete)
