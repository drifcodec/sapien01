...
module.exports = {
  ...
  signup_confirmation_email: async (user_email, user_id, token) => {
    ...
    let info = await transporter.sendMail({
      ...
      //text: "Read bellow", // plain text body ${user_id} href='http://localhost:3000/pg/web/user_mngmt/confirm_account.html?key=${token}'
      ...
      <h2>
      Hi ${user_id},<br>
      User you have been Assign to our System
      </h2>
     <p style='color:#A9A9A9;'>
      Please Click on the link to activate  you account<a style='text-decoration: none;' href='https://cpma.herokuapp.com//pg/web/user_mngmt/confirm_account.html?key=${token}'> Click here</a>. 
     </p>
