  ...
  signup_confirmation_email: async (user_email,user_id,token)=> {
        ...
        let info = await transporter.sendMail({
          ...
          html: `<div style='width:80%; border:5px solid #B32018;margin-left:auto; margin-right:auto; padding: 15px; margin-bottom: 20px;  border-radius: 4px;background:white'>
                ...
                <p>your user is: ${user_id} </p> 
                <p>password  is: CGOS123 </p>
                <p style='color:#A9A9A9;'>
                 You can click on this link to log in <a style='text-decoration: none;' href='http://localhost:3000/api/user/signup_confirmation_email/${token}'>Click here</a>. 
                </p>
                <p style='color:#A9A9A9;'>
                 You are in. You can click on this link to activate <a style='text-decoration: none;' href='http://localhost:3000/api/user/signup_confirmation_email/${token}'>Click here</a>. 
                </p>
                <a style='text-decoration: none; color: #337ab7;'>         
                </a>
