...
module.exports = {
  ...
  signup_confirmation_email: async (user_email, user_id, token) => {
    ...
    let info = await transporter.sendMail({
      ...
      html: `
                <div style='width:80%; border:5px solid #B32018;margin-left:auto; margin-right:auto; padding: 15px; margin-bottom: 20px;  border-radius: 4px;background:white'>
                 <a href='#'>
                 ...
                 <h2>
                 Dear  ${user_id},<br> User you have been Assign to our System
                 </h2>
                <p style='color:#A9A9A9;'>
                 Please Click on this link to activate you account<a style='text-decoration: none;' href='https://cpma.herokuapp.com/pg/web/user_mngmt/confirm_account.html?key=${token}'> Click here</a>. 
                </p>
